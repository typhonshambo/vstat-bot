...
import json
from .utils.recentMatch_utils import  getingamename, GetMatchData, matchStat
...
class recentMatch(commands.Cog):
    ...
    async def recent(self, ctx):
        ...
        ingamename = getingamename(region,userid)
        user_name = ingamename['data']['name']
        tagline = ingamename['data']['tag']

        match_data = await GetMatchData(region,userid)
